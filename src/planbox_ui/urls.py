...
from .views import (index_view, about_view, shareabouts_view, how_we_work_view, project_view, new_project_view, signup_view,
...
urlpatterns = patterns('',
    ...
    url(r'^how-we-work/$', how_we_work_view, name='app-how-we-work'),
)
