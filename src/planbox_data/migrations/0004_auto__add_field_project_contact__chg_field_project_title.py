...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.contact'
        db.add_column(u'planbox_data_project', 'contact',
    ...
    def backwards(self, orm):
        # Deleting field 'Project.contact'
        db.delete_column(u'planbox_data_project', 'contact')
    ...
    models = {
        ...
        u'planbox_data.project': {
            ...
            'contact': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'description': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
