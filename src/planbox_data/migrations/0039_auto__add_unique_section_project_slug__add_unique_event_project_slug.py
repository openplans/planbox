...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Section', fields ['project', 'slug']
        db.create_unique(u'planbox_data_section', ['project_id', 'slug'])

        # Adding unique constraint on 'Event', fields ['project', 'slug']
        db.create_unique(u'planbox_data_event', ['project_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['project', 'slug']
        db.delete_unique(u'planbox_data_event', ['project_id', 'slug'])

        # Removing unique constraint on 'Section', fields ['project', 'slug']
        db.delete_unique(u'planbox_data_section', ['project_id', 'slug'])
