...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Theme.css_url'
        db.delete_column(u'planbox_data_theme', 'css_url')

        # Deleting field 'Theme.js_url'
        db.delete_column(u'planbox_data_theme', 'js_url')


    def backwards(self, orm):
        # Adding field 'Theme.css_url'
        db.add_column(u'planbox_data_theme', 'css_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Theme.js_url'
        db.add_column(u'planbox_data_theme', 'js_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)
