...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planbox_data_user', 'affiliation',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.affiliation'
        db.delete_column(u'planbox_data_user', 'affiliation')
