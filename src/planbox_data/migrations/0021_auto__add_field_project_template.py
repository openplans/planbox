...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planbox_data_project', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planbox_data.Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.template'
        db.delete_column(u'planbox_data_project', 'template_id')
    ...
    models = {
        ...
        u'planbox_data.project': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planbox_data.Project']", 'null': 'True', 'blank': 'True'}),
        ...
        u'planbox_data.section': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'details': ('jsonfield.fields.JSONField', [], {'default': "u'{}'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
