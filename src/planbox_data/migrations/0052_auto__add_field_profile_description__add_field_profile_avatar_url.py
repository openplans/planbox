...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planbox_data_profile', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Profile.avatar_url'
        db.add_column(u'planbox_data_profile', 'avatar_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'planbox_data_profile', 'description')

        # Deleting field 'Profile.avatar_url'
        db.delete_column(u'planbox_data_profile', 'avatar_url')
    ...
    models = {
        ...
        u'planbox_data.profile': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128', 'blank': 'True'}),
