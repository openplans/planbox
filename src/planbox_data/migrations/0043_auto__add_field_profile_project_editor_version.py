...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.project_editor_version'
        db.add_column(u'planbox_data_profile', 'project_editor_version',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.project_editor_version'
        db.delete_column(u'planbox_data_profile', 'project_editor_version')
    ...
    models = {
        ...
        u'planbox_data.profile': {
            ...
            'project_editor_version': ('django.db.models.fields.PositiveIntegerField', [], {}),
