...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'planbox_data_project', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Project.location'
        db.alter_column(u'planbox_data_project', 'location', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Event.label'
        db.alter_column(u'planbox_data_event', 'label', self.gf('django.db.models.fields.TextField')())
