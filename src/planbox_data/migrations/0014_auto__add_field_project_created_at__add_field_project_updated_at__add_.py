...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planbox_data_project', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Project.updated_at'
        db.add_column(u'planbox_data_project', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Profile.created_at'
        db.add_column(u'planbox_data_profile', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Profile.updated_at'
        db.add_column(u'planbox_data_profile', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 10, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'planbox_data_project', 'created_at')

        # Deleting field 'Project.updated_at'
        db.delete_column(u'planbox_data_project', 'updated_at')

        # Deleting field 'Profile.created_at'
        db.delete_column(u'planbox_data_profile', 'created_at')

        # Deleting field 'Profile.updated_at'
        db.delete_column(u'planbox_data_profile', 'updated_at')
