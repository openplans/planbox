...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.thumbnail_url'
        db.add_column(u'planbox_data_attachment', 'thumbnail_url',
                      self.gf('django.db.models.fields.URLField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.thumbnail_url'
        db.delete_column(u'planbox_data_attachment', 'thumbnail_url')
