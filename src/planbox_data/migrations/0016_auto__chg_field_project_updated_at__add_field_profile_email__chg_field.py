...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.updated_at'
        db.alter_column(u'planbox_data_project', 'updated_at', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Profile.email'
        db.add_column(u'planbox_data_profile', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


        # Changing field 'Profile.updated_at'
        db.alter_column(u'planbox_data_profile', 'updated_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Project.updated_at'
        db.alter_column(u'planbox_data_project', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'Profile.email'
        db.delete_column(u'planbox_data_profile', 'email')


        # Changing field 'Profile.updated_at'
        db.alter_column(u'planbox_data_profile', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
