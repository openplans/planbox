...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'planbox_data_attachment', (
            ...
            ('attached_to_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('attached_to_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
        ))
        db.send_create_signal(u'planbox_data', ['Attachment'])


    def backwards(self, orm):
        # Deleting model 'Attachment'
        db.delete_table(u'planbox_data_attachment')
