...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planbox_data_project', 'public',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'planbox_data_project', 'public')
    ...
    models = {
        ...
        u'planbox_data.user': {
            'Meta': {'object_name': 'User'},
            'auth': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'planbox_user'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
