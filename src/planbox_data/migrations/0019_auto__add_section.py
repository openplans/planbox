...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'planbox_data_section', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planbox_data.Project'])),
            ...
            ('menu_label', self.gf('django.db.models.fields.TextField')()),
            ('details', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'planbox_data', ['Section'])


    def backwards(self, orm):
        # Deleting model 'Section'
        db.delete_table(u'planbox_data_section')
    ...
    models = {
        ...
        u'planbox_data.project': {
            ...
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'projects'", 'null': 'True', 'to': u"orm['planbox_data.Theme']"}),
        ...
        u'planbox_data.section': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planbox_data.Project']"}),
