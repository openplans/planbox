...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.theme'
        db.alter_column(u'planbox_data_project', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['planbox_data.Theme']))

        # Changing field 'Project.title'
        db.alter_column(u'planbox_data_project', 'title', self.gf('django.db.models.fields.TextField')(max_length=1024))

        # Changing field 'Project.location'
        db.alter_column(u'planbox_data_project', 'location', self.gf('django.db.models.fields.TextField')(max_length=256))

        # Changing field 'Project.template'
        db.alter_column(u'planbox_data_project', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planbox_data.Project'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Event.label'
        db.alter_column(u'planbox_data_event', 'label', self.gf('django.db.models.fields.TextField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Project.theme'
        db.alter_column(u'planbox_data_project', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planbox_data.Theme'], null=True))

        # Changing field 'Project.title'
        db.alter_column(u'planbox_data_project', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Project.location'
        db.alter_column(u'planbox_data_project', 'location', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Project.template'
        db.alter_column(u'planbox_data_project', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planbox_data.Project'], null=True))

        # Changing field 'Event.label'
        db.alter_column(u'planbox_data_event', 'label', self.gf('django.db.models.fields.CharField')(max_length=1024))
    ...
    models = {
        ...
        u'planbox_data.event': {
            ...
            'label': ('django.db.models.fields.TextField', [], {'max_length': '1024'}),
        ...
        u'planbox_data.project': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.TextField', [], {'default': "u''", 'max_length': '256', 'blank': 'True'}),
            ...
            'title': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },
